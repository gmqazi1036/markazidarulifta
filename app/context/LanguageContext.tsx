...
const translations: TranslationDict = {
  ...
  pubBookstoreText: { en: "We are developing a dedicated platform through which readers around the world will be able to obtain authentic Islamic publications with ease. The platform will also provide reliable PDF and E-Publications, ensuring that valuable Islamic literature reaches readers across the globe safely and conveniently.", ur: "ہم ایک ایسے پلیٹ فارم پر کام کر رہے ہیں جس کے ذریعے دنیا بھر کے قارئین مستند اسلامی مطبوعات حاصل کر سکیں گے۔ اس پلیٹ فارم کے ذریعے ملکی و بین الاقوامی سطح پر محفوظ اور قابلِ اعتماد ترسیل کی سہولت بھی فراہم کی جائے گی۔" },
